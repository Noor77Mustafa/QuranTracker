    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="p-4 flex flex-col items-center">
        <div className="text-center mb-4">
          <p className="font-amiri text-5xl mb-2 leading-tight">الفَاتِحَة</p>
          <p className="text-sm text-gray-600 dark:text-gray-400">1. Al-Fatihah (The Opener)</p>
        </div>
        <Link href="/surah/1">
          <a className="bg-primary text-white px-6 py-2 rounded-full text-sm font-medium hover:bg-primary/90 transition">
            Begin
          </a>
        </Link>
      </div>
